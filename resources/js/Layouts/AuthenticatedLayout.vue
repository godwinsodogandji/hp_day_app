...
onMounted(() => {
    lottie.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        path: '' // URL de votre animation Lottie
    });
});
</script>
...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 relative"> <!-- Ajout de relative ici -->
...
<style>
/* Assurez-vous que le conteneur Lottie est sous le contenu principal */
#lottie {
    z-index: 0;
}
</style>
