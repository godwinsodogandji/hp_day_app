    ...
    <AuthenticatedLayout>
        ...
        <div class="py-1">
            ...
            <div class="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-11">
                ...
                <!-- Section des anniversaires à venir -->
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold mb-2">
                        Anniversaires à venir
                    </h2>
                    <div class="flex gap-4 justify-center">
                        <!-- Message si aucun anniversaire à venir -->
                        <div
                        ...
                        <!-- Boucle pour afficher les anniversaires -->
                        <div
                        ...
                        >
                            ...
                            <!-- Information de l'ami avec anniversaire -->
                            <div class="flex flex-col items-center p-4">
                                <!-- Afficher l'image de profil (avatar) ou fallback si l'avatar est manquant -->
                                <img
                                    class="w-20 h-20 mb-3 rounded-full shadow-lg"
                                    :src="
                                        birthday.user.profilePicture ||
                                        '/images/default-avatar.png'
                                    "
                                    :alt="
                                        'Profile image of ' + birthday.user.name
                                    "
                                />
            ...
            <div class="text-center mt-8">
                <h2
                    ...
                    style="font-family: 'Charme', sans-serif"
                >
                    🎂 Qui garde son âme d'enfant ne vieillit jamais. Pensez à
                    vos proches ! 🎂
                </h2>
            </div>
        </div>
