<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex justify-center items-center min-h-screen bg-gray-100">
            ...
            <div
                class="max-w-sm bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg shadow-xl overflow-hidden"
            >
                <a href="#">
                    <img
                        class="w-full h-56 object-cover object-center"
                        src="460527440_122108597888520279_5627712991740032276_n.jpg"
                        alt="Image d'anniversaire"
                    />
                </a>
                <div class="p-6 text-white">
                    <h5
                        class="mb-4 text-3xl font-semibold tracking-tight text-center"
                    >
                        ❤️ Pour la personne qui occupe une place spéciale dans
                        mon cœur
                    </h5>
                    ...
                    <button
                        ...
                        class="inline-flex items-center px-4 py-3 mt-6 text-sm font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-300"
                    >
