                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="/upcoming-birthdays"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Anniversaire à venir</span>
                                <span
                        ...
                        <div v-for="friend in upcomingBirthdays" :key="friend.id"
                            ...
                            <div class="flex flex-col items-center p-4">
                                ...
                                <div class="flex mt-4 md:mt-6">
                                    <button
                                        class="bg-blue-500 text-white py-1 px-3 rounded hover:bg-blue-600" @click="wish" >Souhaiter</button>
                                </div>
                            </div>
                        </div>
                    </div>
